...
package org.usfirst.frc6333.Linda;

import org.usfirst.frc6333.Linda.commands.*;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;
import edu.wpi.first.wpilibj.Joystick;
import edu.wpi.first.wpilibj.buttons.*;
import org.usfirst.frc6333.Linda.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        fullSpeedButton = new JoystickButton(mainStick, 1);
        fullSpeedButton.whileHeld(new DriveFullSpeed());
        climbDownButton = new JoystickButton(mainStick, 11);
        climbDownButton.whileHeld(new ClimbDown());
        climbUpButton = new JoystickButton(mainStick, 7);
